...
categories = {
        ...
        "Bargeld": ["bank", "B.C.P", "BANK", "VOLKSBANK", "SPARKASSE", "SPARDA", "COMMERZBANK", "CTT", "SPK", "INGDIBA",
                    "POSTBANK", "EVANGELISCHE BANK", "VB", "STN", "VALENCIA", "HVB", "ATM"],
        "Versicherungen": ["Techniker", "Hansemerkur", "versicherung", "AOK", "Allianz", "Signal", "Iduna", "TK",
                           "DEBEKA"],
